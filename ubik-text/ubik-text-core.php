...
// Text replacement; expands on core `wptexturize` function to provide additional shorthand and clean-up
// @filter: ubik_text_replacement
function ubik_text_replacement( $content = '' ) {

  $replacement_map = apply_filters( 'ubik_text_replacement', array(
    '&#8212;' => '&#8202;&#8212;&#8202;' // Surround em dashes in hair spaces;
  , '==>'     => '&nbsp;&rarr;'
  , '<=='     => '&larr;&nbsp;'
  ) );

  foreach ( $replacement_map as $pattern => $replacement ) {
