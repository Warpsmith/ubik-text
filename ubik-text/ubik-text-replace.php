...
function ubik_text_replace_diacritics() {
  ...
  , 'Aeon '             => '&AElig;on '
  , ' aeon'             => ' &aelig;on'
  , 'Aesthetics '       => '&AElig;sthetics '
  , 'Aesthetic '        => '&AElig;sthetic '
  , ' aesthetic'        => ' &aelig;sthetic'
  , ' aesthete'         => ' &aelig;sthete'
  , 'Aether '           => '&AElig;ther '
  , ' aether'           => ' &aelig;ther'
  , 'Algae '            => 'Alg&aelig; '
  , ' algae'            => ' alg&aelig;'
  , 'Anaesthesia '      => 'An&aelig;sthesia '
  , ' anaesthesia'      => ' an&aelig;sthesia'
  , 'Antennae '         => 'Antenn&aelig; '
  , ' antennae'         => ' antenn&aelig;'
  , 'Archaeolog'        => 'Arch&aelig;olog'
  , ' archaeolog'       => ' arch&aelig;olog'
  , ' encyclopaed'      => ' encyclop&aelig;d' // Encyclopaedia
  , ' encycloped'       => ' encyclop&aelig;d' // Encyclopedia
  , ' daemon'           => ' d&aelig;mon' // Daemon
  , ' diaeresis'        => ' di&aelig;resis' // Diaeresis
  , ' formulae'         => ' formul&aelig;' // Formulae
  , 'Medieval '         => 'Medi&aelig;val '
  , ' medieval'         => ' medi&aelig;val'
  , ' nebulae'          => ' nebul&aelig;' // Nebulae
  , ' novae'            => ' nov&aelig;'
  , 'Paleoclimate '     => 'Pal&aelig;oclimate'
  , 'Paleoclimatology ' => 'Pal&aelig;oclimatology'
  , ' paleo'            => ' pal&aelig;o'
  , 'Pangaea'           => 'Pang&aelig;a' // Pangaea
  , ' personae'         => ' person&aelig;' // Personae
  , ' primeval'         => ' prim&aelig;val' // Primeval
  , ' supernovae'       => ' supernov&aelig;'
  ...
  , ' bric-a-brac'      => ' bric-&agrave;-brac'
  , 'Cliche '           => 'Clich&eacute; '
  , 'Cliches '          => 'Clich&eacute;s '
  , ' cliche'           => ' clich&eacute;'
  , ' cooperat'         => ' co&ouml;perat' // Cooperate; covers several variants
  , ' coordinat'        => ' co&ouml;rdinat' // Coordinate
  , ' coup de grace'    => ' coup de gr&acirc;ce' // Coup de grace
  , ' dais '            => ' da&iuml;s ' // Spaced out
  , ' declasse'         => 'd&eacute;class&eacute;'
  , 'Deja vu '          => 'D&eacute;j&agrave; vu ' // Deja vu
  , ' deja vu'          => ' d&eacute;j&agrave; vu' // Deja vu
  , ' denouement'       => ' d&eacute;nouement' // Denouement
  , ' detente'          => ' d&eacute;tente'
  , ' doppelganger'     => ' doppelg&auml;nger' // Doppelganger
  ...
  , 'Jalapeno '         => 'Jalape&ntilde;o ' // Jalapeno
  , ' jalapeno'         => ' jalape&ntilde;o' // Jalapeno
  ...
  , ' Quebec'           => ' Qu&eacute;bec'
  , ' smorgasbord'      => ' sm&ouml;rg&aring;sbord'
  ) );
}
